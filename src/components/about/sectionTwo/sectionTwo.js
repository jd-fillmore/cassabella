...
const AboutIntroTwo = () => {
  const aboutContent = {
    ...
    textTwo:
      "His long time friend, Charles Sciberras, one of Torontoâ€™s most respected design/cost professionals with over twenty years of experience is one of the assets that sets Cass-A-Bella apart from their competition. The combination of Fernando and Charles each skillfully doing their respective part in the company has allowed the company to run smoothly and effectively. Charles Sciberras has designed hundreds of projects, all focused on architectural considerations, return on investment, family functionality and budget requirements. He presently designs the over all look and functionality of each project calculating the cost in relationship to investment.",
    textThree:
